                ...
                <Section opacity={opacityLastSection}>
                    <blockquote className="p-6 text-base font-bold">
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <a href="https://wa.me/6289525336399" title="Link Whatsapp Krisna" className="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank" rel="noopener noreferrer">
